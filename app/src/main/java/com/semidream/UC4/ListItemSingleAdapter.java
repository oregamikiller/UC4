...
public class ListItemSingleAdapter extends BaseAdapter {
	private Context context;
	private ArrayList<ListItemSingle> list = new ArrayList<ListItemSingle>();
	
	public ListItemSingleAdapter(Context context,ArrayList<ListItemSingle> list){
	...
	public View getView(int position, View view, ViewGroup parent) {
		ListItemSingle hh = list.get(position);
		H h = null;
		if(view==null){
			h = new H();
